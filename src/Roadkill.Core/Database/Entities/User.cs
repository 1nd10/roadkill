...
namespace Roadkill.Core.Database
{
    ...
    public class User : IDataStoreEntity
    {
        ...
        /// <summary>
        ///     This field is for page modified by/created by, and is a 'friendly' name. For windows auth the email field is used
        ///     instead.
        /// </summary>
        ...
        {
            var isFormsAuthEnabled = FormsAuthenticationWrapper.IsEnabled();
